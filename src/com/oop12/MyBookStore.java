...
public class MyBookStore {
    ...
    public static void searchByTitle(Scanner sc, Book[] books) {
        ...
        // 검색결과 발견하면 true로 반환후 break;  검색결과 없으면 단독 if문 실행해서 걸림.
        for (int i = 0; i < books.length; i++) {
            if (books[i] != null) {
    ...
    public static void deleteByTitle(Scanner sc, Book[] books) {
        ...
        books[lastIndexNumber - 1] = null; // [A][C][D][null] 맨 뒤 인덱스가 비워졌으니 맨 뒷자리 null로 만듦.
    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            System.out.println("1.저장 2.전체조회 3.선택조회 4.전체 삭제 5.선택 삭제 0.종료");
