    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if(choice == ZEALOT) {
                ...
                if(attackChoice == ZEALOT_TO_ZERGLING) z1.attackZergling(zg1);
                    else if(attackChoice == ZEALOT_TO_MARINE) z1.attackMarine(m1);
                ...
                if(attackChoice == ZERGLING_TO_ZEALOT) zg1.attackZealot(z1);
                else if(attackChoice == ZERGLING_TO_MARINE) zg1.attackMarine(m1);
                ...
                if(attackChoice == MARINE_TO_ZEALOT) m1.attackZealot(z1);
                else if(attackChoice == MARINE_TO_ZERGLING) m1.attackZergling(zg1);
